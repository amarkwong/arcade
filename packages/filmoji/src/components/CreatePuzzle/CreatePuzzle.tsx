    ...
    >
      <div className="flex min-h-screen w-screen items-center justify-center p-6">
        <div className="w-full max-w-lg rounded-2xl bg-slate-900 p-6 text-slate-50 shadow-xl shadow-cyan-500/30">
          ...
          <button className="text-sm text-slate-300 hover:text-slate-100" onClick={onClose}>
            X
          </button>
        </div>
        <form className="mt-5 flex flex-col gap-4" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="space-y-2">
            <p className="text-xs uppercase tracking-[0.2em] text-slate-300">Poster (auto-fetched)</p>
            ...
            <div
              className="relative w-full overflow-hidden rounded-lg bg-slate-900/60 shadow-md"

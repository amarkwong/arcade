	...
	return (
		<div className="relative mx-auto w-full max-w-4xl px-4">
			<div className="flex items-center justify-between gap-3">
				<Link
					href="/GameSelector"
					className="rounded-full border border-cyan-500/40 bg-slate-900/70 px-3 py-2 text-xs font-semibold tracking-wide text-cyan-100 shadow-sm transition hover:border-cyan-300/70 hover:text-white"
				>
					Back to Arcade
				</Link>

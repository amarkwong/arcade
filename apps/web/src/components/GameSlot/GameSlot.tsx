    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-between px-4 py-5 text-center">
        ...
        <div className="space-y-1">
          <p className="text-sm font-semibold uppercase tracking-wide text-cyan-100 drop-shadow-[0_2px_10px_rgba(0,255,255,0.35)]">
            {caption}
          </p>
          <p className="text-[10px] uppercase tracking-[0.25em] text-fuchsia-200/80">
            {active ? "Press Enter to play" : "Click to select"}
          </p>
        </div>
      </div>
